...
abstract class HTMLBuilder{
  ...
  static String build(
    ...
    html.write(
        ' style="background-color: rgb(${backgroundColor.red}, ${backgroundColor.green}, ${backgroundColor.blue}); margin-top: 29%; margin-left: -5%; width: 100%; height: 80%; --poster-color: transparent; --progress-bar-height: 0px"');
    if (alt != null) {
