...
abstract class HTMLBuilder {
  ...
  static String build(
    ...
    html.write(
        'id="mainModel" src="${htmlEscape.convert(src)}" animation-name="$animationName"');
    html.write(
    ...
    html.writeln(
        '<script>(() => {const modelViewer = document.querySelector("#mainModel");self.setInterval(() => {modelViewer.animationName = modelViewer.animationName === "Armature.002|mixamo.com|Layer0" ? "Armature.006|mixamo.com|Layer0" : "Armature.002|mixamo.com|Layer0";}, 1500.0);})();</script>');
    html.writeln('</body>');
